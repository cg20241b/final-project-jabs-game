...
// Movement and event functions
const applyGravity = () => {
  if (!isMoving) {
    gravityRay.set(character.position, new THREE.Vector3(0, 0, -1));
    // Gravity visualization for debugging
...
const getMapLocation = (vectorLocation) => {
  return {
...
const getActualPosition = (mapVector) => {
